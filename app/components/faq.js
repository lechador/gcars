...
export default function Faq() {
    ...
    },
    {
        ...
        answer: "ავტოექსპერტი უზრუნველყოფს აშშ მსხვილ აუქციონებზე (COPART.COM, IAAI.COM) თქვენი მოთხოვნების შესაბამისი ავტომობილის მოძიებას. ის პასუხისმგებელია აუქციონზე მის შეძენასა და სრულ ტრანსპორტირებაზე ფოთამდე."
    },
    {
        question: "როგორ დაგიკავშირდეთ?",
        answer: "დაგვიკავშირდით ინდიგო ქარს-ის ცხელ ხაზზე: +995 032 00000000"
    },]
  return (
