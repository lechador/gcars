...
export default function ContactInfo() {
  return (
    ...
    <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-12 py-5 bg-black">
          ...
          <div className="flex flex-col items-center">
            <svg xmlns="http://www.w3.org/2000/svg" className="w-6 fill-white" viewBox="0 0 473.806 473.806">
          ...
          <div className="flex flex-col items-center">
            ...
            <div className="mt-4 text-center">
              <h4 className="text-yellow-500 text-base font-bold">მოგვწერე</h4>
              <p className="text-sm text-white mt-2">info@gcars.ge</p>
            </div>
          </div>  
</div>
</div>
